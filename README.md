...
3. Clone and install the you-get project ```git clone https://github.com/soimort/you-get```
4. Follow the instructions on ```src/config.py``` to get the whatsapp credentials.  
